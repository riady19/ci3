                     ...
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="m-0 font-weight-bold text-primary"> <h3><?= $title;?></h3>
                              ...
                              <a href="" class="btn btn-primary mb-3 float-right" data-toggle="modal" data-target="#exampleModal">Add New</a>
...
" id="exampleModalLabel">Form Edit Data</h5>
      ...
      <div class="modal-body">
        ...
        <form method="post" action="<?= base_url('Siswa/proses_edit_data') ?>" enctype="multipart/form-data">
...
<div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <img src="<?php echo base_url() . './gambar/' . $sis['foto']; ?>" style="width: 80px;" class="img-thumbnail">
  </div>
...
" id="exampleModalLabel">Form Input Data</h5>
      ...
      <div class="modal-body">
        ...
        <form method="post" action="<?= base_url('siswa/proses_tambah_data') ?>" enctype="multipart/form-data">
<div class="form-group row">
    <label for="nis" class="col-sm-3 col-form-label">NIS</label>
    <div class="col-sm-8">
